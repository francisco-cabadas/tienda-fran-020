...
<table border="1">
  ...
  ?>
    ...
    <tr>
      <td><a href='producto-detalle.php?id=<?= $producto->getId() ?>'><?= $producto->getNombre() ?></a></td>
      ...
      <td class="text-center"><a href="carrito-gestionar-producto.php?productoId=<?= $producto->getId() ?>&variacionUnidades=eliminar">X</a></td>
    </tr>
